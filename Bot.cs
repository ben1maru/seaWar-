...
namespace SeaWars
{
    public class Bot
    {
        public int[,] myMap = new int[FrmMain.mapSize, FrmMain.mapSize];//bot`s map
        public int[,] enemyMap = new int[FrmMain.mapSize, FrmMain.mapSize];//player`s map

        public Button[,] myButtons = new Button[FrmMain.mapSize, FrmMain.mapSize];
        public Button[,] enemyButtons = new Button[FrmMain.mapSize, FrmMain.mapSize];
        ...
        {
            if(i<0 || j<0 || i>= FrmMain.mapSize || j>= FrmMain.mapSize)
            {
                return false;
            }
            return true;
        ...
        public int[,] ConfigureShips()
        {
            ...
            while (shipsCount > 0)
            {
                ...
                {
                    posX = r.Next(1, FrmMain.mapSize);
                    posY = r.Next(1, FrmMain.mapSize);
        ...
        public bool Shoot()
        {
            ...
            int posX = r.Next(1, FrmMain.mapSize);
            int posY = r.Next(1, FrmMain.mapSize);
